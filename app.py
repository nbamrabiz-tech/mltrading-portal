        ...
        with col_brief:
            ...
            try:
                with engine.connect() as conn:
                    ...
                    # Capital preserved
                    # Check last No Edge day actual move
                ...
                if streak >= 1:
                    st.markdown(
                        ...
                        f"No Edge days respected</b>"
                        f"<br><span style='color:#666;"
                        f"font-size:12px;'>"
                        f"Discipline is building. "
                        f"Every sit-out counts."
                        f"</span></div>",
                        unsafe_allow_html=True
                    )
